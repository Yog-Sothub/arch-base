...
sudo pacman -S xorg thunar firefox redshift newsboat picom mpc mpv mpd ncmpcpp ffmpeg youtube-dl bat dunst arc-solid-gtk-theme papirus-icon-theme fish starship keepassxc htop neofetch ttf-dejavu gnu-free-fonts ttf-liberation noto-fonts ttf-hack ttf-fira-code adobe-source-code-pro-fonts noto-fonts-cjk noto-fonts-emoji ttf-fira-mono
