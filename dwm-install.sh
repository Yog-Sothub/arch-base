...
sudo pacman -S xorg thunar firefox redshift xorg-xinit lxappearance neovim evince newsboat picom mpc mpv mpd ncmpcpp ffmpeg youtube-dl bat dunst arc-solid-gtk-theme papirus-icon-theme fish starship keepassxc htop neofetch sxiv ranger ueberzug nitrogen mousepad playerctl xarchiver thunar-archive-plugin unrar unzip wget raw-thumbnailer transmission-gtk ttf-dejavu gnu-free-fonts ttf-liberation noto-fonts ttf-hack ttf-fira-code adobe-source-code-pro-fonts noto-fonts-cjk noto-fonts-emoji ttf-fira-mono ttf-joypixels
...
paru -S dockd nerd-fonts-fira-code libxft-bgra downgrade timeshift-autosnap 
